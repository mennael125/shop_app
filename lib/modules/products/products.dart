          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                categoryBuilder(ECommerceCubit.get(context).categoryModel),
                SizedBox(
                  height: 20,
                ),
                Text(
          ...
          children: [
            ...
            Row(
              children: [
                ...
                Spacer(),
                CircleAvatar(
                  backgroundColor: ECommerceCubit.get(context).favorite[model.id]!
                      ? defaultColor
                      : Colors.grey,
                  radius: 15,
                  child: IconButton(
                    onPressed: () {
                      ECommerceCubit.get(context).changeFavorite(model.id);
                      print ( model.id)
;                    },
                    icon: Icon(
          ...
          SizedBox(height:10),
          defaultButton(text: 'Add to cart', fun: (){
            ECommerceCubit.get(context).addCarts(model.id);
            ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                content: const Text('Added to cart successfully!'),padding: EdgeInsetsDirectional.all(20),duration: Duration( milliseconds: 800),));
          }, isUpper: true ),
          ],
        ),
      ),
