import 'package:e_commerce_payment/modules/seetings/terms.dart';
import 'package:e_commerce_payment/modules/seetings/user_information.dart';
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<ECommerceCubit, ECommerceStates>(
      ...
      builder: (context, state) {
        var model = ECommerceCubit.get(context).userModel;
        if (model != null) {
